...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--load_pretrain', type=str, default='', help='local rank for distributed training')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/edges2phtd1024/') 
